      ...
      <div className="flex flex-col">
        ...
        <p className="text-[16px] mt-10 w-full lg:w-[80%]">
          ...
          <a
            ...
            className="flex items-center justify-center mt-6 w-[150px] py-3 text-sm font-semibold text-white bg-gradient-to-r from-white/10 to-gray-100/20 rounded-full shadow-md transition-transform transform hover:scale-105 hover:shadow-lg"
          >
            Download CV
          </a>
      </div>
